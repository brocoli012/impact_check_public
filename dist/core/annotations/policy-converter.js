...
exports.convertAnnotationsToPolicies = convertAnnotationsToPolicies;
 ...
 */
function convertAnnotationsToPolicies(annotations) {
    const results = [];
    let idCounter = 0;
 ...
 */
function mergePolicies(indexPolicies, annotationPolicies) {
 ...
 */
function makePolicyKey(filePath, name) {
...
//# sourceMappingURL=policy-converter.js.map