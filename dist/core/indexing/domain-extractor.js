...
exports.DomainExtractor = void 0;
/**
 * 도메인 키워드 매핑 테이블
...
class DomainExtractor {
     ...
     */
    containsKeywordInPath(filePath, keyword) {
     ...
     * 최대 10개 항목 반환
     */
    generateFeatureSummary(codeIndex) {
        // API를 경로 prefix로 그룹핑
        ...
        for (const [prefix, apis] of Object.entries(apiGroups)) {
            ...
            const alreadyCovered = summaries.some(s => s.toLowerCase().includes(prefix.toLowerCase()));
     ...
     */
    countRelatedApis(screens, allApis) {
...
//# sourceMappingURL=domain-extractor.js.map