...
export class AnnotationLoader {
  ...
  constructor(basePath?: string) {
    this.manager = new AnnotationManager(basePath);
  }
   ...
   */
  async loadForProject(projectId: string): Promise<Map<string, AnnotationFile>> {
   ...
   */
  async loadForFile(projectId: string, filePath: string): Promise<AnnotationFile | null> {
   ...
   */
  async loadForFiles(projectId: string, filePaths: string[]): Promise<Map<string, AnnotationFile>> {
   ...
   */
  async getProjectMeta(projectId: string): Promise<AnnotationMeta | null> {
